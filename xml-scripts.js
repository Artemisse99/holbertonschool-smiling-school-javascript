    ...
    $.ajax({
        ...
        $("#QuotesLoader").show();
          ...
          success: function(response) {
            $("#QuotesLoader").hide();
            $(response).find('quote').each(function(i, el) {
              let $html = $(`
        ...
        $.ajax({
          ...
          success: function(response) {
            $("#VideosLoader").hide();
                $(response).find('video').each(function(i, el) {
                  let $stars = '';
            ...
            $.ajax({
                ...
                $("#CoursesLoader").show();
                  ...
                  success: function(response) {
                    $("#CoursesLoader").hide();
                    let $topics = '';
                    $(response).find('topics').find('topic').each(function(i, el) {
                      let $t = $(this).text();
                      if (i === 0) {
                    ...
                    let $sorts = '';
                    $(response).find('sorts').find('sort').each(function(i, el) {
                      let $s = $(this).text();
                      if (i === 0) {
                  ...
                  $.ajax({
                      ...
                      $("#CoursesLoader").show();
                        ...
                        success: function(response) {
                          ...
                          $(response).find('courses').find('course').each(function(i, el) {
                          let $stars = '';
                          for (let j = 0; j < $(this).attr('star'); j++) {
                            $stars += '<img src="./images/star_on.png" class="mr-1 carousel-star-icon" alt="star icon filled in purple">';
                          }
